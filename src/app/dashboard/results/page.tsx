                                                    ...
                                                    {selectedResult.status === "compliant" ? (
                                                        ...
                                                        <div className="flex flex-col h-full justify-between px-1">
                                                            <div>
                                                                ...
                                                                <h4 className="text-[13px] font-bold text-rose-800 mb-2">RTA Hold Risk Detected</h4>
                                                                <p className="text-xs font-medium text-slate-500 leading-relaxed mb-6">
                                                                    <strong className="text-rose-600 block mb-1">Bleed Metric: 90-Day Delay + ~$30k Burn</strong>
                                                                    This gap introduces immediate regulatory risk. To prevent an FDA 90-day review clock reset, the missing evidence must be generated by your engineering team.
                                                                </p>
