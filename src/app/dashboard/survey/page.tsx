        ...
        <div className="max-w-4xl mx-auto pb-20">
            <div className="mb-10">
                ...
                <p className="text-lg font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 tracking-tight">
                    Help us perfect the future of MedTech regulatory automation.
                </p>
                <p className="text-slate-500 mt-2 text-sm max-w-3xl leading-relaxed">
                    Provide detailed feedback on your TraceBridge AI experience. Your insights will directly inform the platform's accuracy and usability for regulatory affairs professionals. Estimated time: 5-7 minutes.
                </p>
            </div>
